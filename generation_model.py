...
class RAGSystem:
    ...
    def retrieve_relevant_chunks(self, query, top_k=5):
        ...
        Returns:
            List[Tuple[str, float]]: A list of tuples containing the chunk text and its similarity score.
        """
    ...
    def generate_answer(self, question, top_k=5):
        ...
        input_tokens = self.tokenizer(input_text, return_tensors='pt', truncation=True, padding=True)
